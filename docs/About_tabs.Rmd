...
<br>
Climate data are compiled and visualized using functions in the <a href="https://github.com/KateMMiller/climateNETN/">climateNETN R package</a>. See <a href="https://katemmiller.github.io/waterNETN/"> https://katemmiller.github.io/waterNETN/</a> (user guide for both waterNETN and climateNETN R packages) </a> for details on how to use the functions in this package. Note that, among other features, you can use the 30-year normal instead of the 20th century normal as the baseline, can use scientific units (e.g., F and mm), and can change color palettes and year ranges in plots within climateNETN functions. 
</details>
