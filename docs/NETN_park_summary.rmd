...
```{r }
# comment out next 3 lines unless troubleshooting
# child_env <- data.frame(park = "MABI", yr_start = 2006,
#                         yr_current = 2026, end_date = "03/03/2026")
# park <- child_env$park
# yr_current <- child_env$yr_current
