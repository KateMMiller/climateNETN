...
<details open><summary class='drop'>Drought Condition</summary>
```{r fig.height=8, fig.width=12.8, results = 'asis', fig.cap = drgt_cap5}
...
```{r fig.height=8, fig.width=12.8, results = "asis", fig.cap = temp_capT}
...
```{r fig.height=8, fig.width=12.8, results = 'asis', fig.cap = ppt_capT}
plotClimTrend(park = parkcode, years = 1900:yr_current,
...
```{r fig.height=8, fig.width=12.8, results = 'asis', fig.cap = drgt_capT}
