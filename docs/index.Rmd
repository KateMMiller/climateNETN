...
params:
  year_current: 2026 # current year of data
  end_date: "04/21/2026" # last day to plot - use last Tues. of month when drought monitor is posted
---
# {.tabset .tabset-pills}
...
leaflet(height = 700) %>%
  ...
  # add button to control map tiles
    addLayersControl(map = ., 
                     baseGroups = c("NatGeo", "Imagery", "Topo"),
